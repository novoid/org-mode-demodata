...
# Time-stamp: <2021-03-14 19:34:29 vk>
# 2021-03-14=referenceday → see https://github.com/novoid/isodateshifter for a tool to shift all time-stamps to your demo day
...
(setq my-demodir "src/Emacs Org mode demo data") ;; please do adapt to your path situation!
(setq org-agenda-files  (concat (file-name-as-directory my-demodir) "Emacs Org mode demo data.org"))
#+END_SRC
...
Project definition according to [[https://karl-voit.at/2019/11/03/org-projects/][this article by Karl Voit]].
